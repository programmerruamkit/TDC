                        ...
                        <div class="card-body">
                            ...
                            <!-- <form name="form2" method="post"> -->
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class='px-2 py-1 border border-slate-200 dark:border-zink-500'>
                                                <select class="form-input appearance-none border-slate-300 focus:outline-none focus:border-custom-500 param3" data-choices-search-false=""><!-- data-choices="" -->
                                                    <option value="">--- โปรดเลือก ---</option>
                                                    <option value="TRAILLERDEISEL" <?php if(isset($_GET['shl'])){if($rs_sheetlist_edit->SHL_PERIODTIME=='TRAILLERDEISEL'){echo "selected";}}?>>เทรลเลอร์ดีเซล</option>
                                                    <option value="TRAILLERTYPEBELT" <?php if(isset($_GET['shl'])){if($rs_sheetlist_edit->SHL_PERIODTIME=='TRAILLERTYPEBELT'){echo "selected";}}?>>เทรลเลอ์ชนิดที่ใช้สายเบลท์ รัดล้อ</option>
                                                </select>
                                            </td>
                                            <?php if(!isset($_GET['shl'])){ ?>
                                                <td class='px-2 py-1 border border-slate-200 dark:border-zink-500'>
                                ...
                                <div class="mb-4">
                                    ...
                                    <button aria-label="button" type="button" onclick="ManageSheetList4LRCCRATC('<?php if(isset($_GET['shl'])){echo $rs_sheetlist_edit->SHL_CODE;}?>','<?php if(isset($_GET['shl'])){echo 'edit4L';}else{echo 'add4L';}?>','<?php echo $_GET['id'];?>','<?php echo $_GET['get'];?>')" class="text-white transition-all duration-200 ease-linear btn bg-green-500 border-green-500 hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100 dark:ring-green-400/20">บันทึกข้อมูล</button>
                                </div>
                            <!-- </form> -->
                        </div>
                    </div>
...
<script type="text/javascript">    
    $(document).ready(function () {
        ...
        $('#add').click(function () {
            ...
            html_code += "<td class='px-2 py-1 border border-slate-200 dark:border-zink-500'><select class='form-input appearance-none border-slate-300 focus:outline-none focus:border-custom-500 param3' data-choices-search-false=''><option value=''>--- โปรดเลือก ---</option><option value='TRAILLERDEISEL'>เทรลเลอร์ดีเซล</option><option value='TRAILLERTYPEBELT'>เทรลเลอ์ชนิดที่ใช้สายเบลท์ รัดล้อ</option></select></td>";
