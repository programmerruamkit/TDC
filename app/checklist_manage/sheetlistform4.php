                        ...
                        <div class="card-body">
                            ...
                            <!-- <form name="form2" method="post"> -->
                                <table id="crud_table" style="width: 100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td contenteditable='true' class='px-2 py-1 border border-slate-200 dark:border-zink-500 param4'><?php if(isset($_GET['shl'])){echo $rs_sheetlist_edit->SHL_HOWTO;}?></td>
                                            <td class='px-2 py-1 border border-slate-200 dark:border-zink-500'>
                                                <select class="form-input appearance-none border-slate-300 focus:outline-none focus:border-custom-500 param5" data-choices-search-false=""><!-- data-choices="" -->
                                                    <option value="">-</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <button aria-label="button" type="button" onclick="ManageSheetList4('<?php if(isset($_GET['shl'])){echo $rs_sheetlist_edit->SHL_CODE;}?>','<?php if(isset($_GET['shl'])){echo 'editform4';}else{echo 'addform4';}?>','<?php echo $_GET['id'];?>','<?php echo $_GET['get'];?>')" class="text-white transition-all duration-200 ease-linear btn bg-green-500 border-green-500 hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100 dark:ring-green-400/20">บันทึกข้อมูล</button>
                                </div>
                            <!-- </form> -->
                        </div>
                    </div>
...
<script type="text/javascript">    
    $(document).ready(function () {
        ...
        $('#add').click(function () {
            ...
            html_code += "<td contenteditable='true' class='px-2 py-1 border border-slate-200 dark:border-zink-500 param4'></td>";
            html_code += "<td class='px-2 py-1 border border-slate-200 dark:border-zink-500'><select class='form-input appearance-none border-slate-300 focus:outline-none focus:border-custom-500 param5' data-choices-search-false=''><option value=''>-</option><option value='ALLDAY'>ทุกวัน</option><option value='ALLWEEK'>ทุกสัปดาห์</option></select></td>";
            html_code += "<td class='px-2 py-1 border border-slate-200 dark:border-zink-500'><select class='form-input appearance-none border-slate-300 focus:outline-none focus:border-custom-500 param6' data-choices-search-false=''><option value=''>-</option><option value='BEFORESTART'>ก่อนติดเครื่องยนต์</option><option value='AFTERSTART'>หลังติดเครื่องยนต์</option><option value='TRAILLER'>เทรลเลอร์</option><option value='BELT'>Belt</option><option value='WIRE'>Wire</option></select></td>";
