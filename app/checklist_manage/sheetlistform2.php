                        ...
                        <div class="card-body">
                            ...
                            <!-- <form name="form2" method="post"> -->
                                ...
                                <div class="mb-4">
                                    ...
                                    <button aria-label="button" type="button" onclick="ManageSheetList2('<?php if(isset($_GET['shl'])){echo $rs_sheetlist_edit->SHL_CODE;}?>','<?php if(isset($_GET['shl'])){echo 'editform2';}else{echo 'addform2';}?>','<?php echo $_GET['id'];?>','<?php echo $_GET['get'];?>')" class="text-white transition-all duration-200 ease-linear btn bg-green-500 border-green-500 hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100 dark:ring-green-400/20">บันทึกข้อมูล</button>
                                </div>
                            <!-- </form> -->
                        </div>
                    </div>
