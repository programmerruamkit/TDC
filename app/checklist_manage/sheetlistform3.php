                        ...
                        <div class="card-body">
                            ...
                            <!-- <form name="form2" method="post"> -->
                                        ...
                                        <tr>
                                            ...
                                            <td class='px-2 py-1 border border-slate-200 dark:border-zink-500'>
                                                <select class="form-input appearance-none border-slate-300 focus:outline-none focus:border-custom-500 param5" data-choices-search-false=""><!-- data-choices="" -->
                                                    <option value="BEFOREWORK" <?php if(isset($_GET['shl'])){if($rs_sheetlist_edit->SHL_PERIODTIME=='BEFOREWORK'){echo "selected";}}?>>ก่อนปฏิบัติงาน</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <button aria-label="button" type="button" onclick="ManageSheetList3('<?php if(isset($_GET['shl'])){echo $rs_sheetlist_edit->SHL_CODE;}?>','<?php if(isset($_GET['shl'])){echo 'editform3';}else{echo 'addform3';}?>','<?php echo $_GET['id'];?>','<?php echo $_GET['get'];?>')" class="text-white transition-all duration-200 ease-linear btn bg-green-500 border-green-500 hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100 dark:ring-green-400/20">บันทึกข้อมูล</button>
                                </div>
                                
                                <?php if(isset($_GET['shl'])){ ?>
                                    <!-- <br> -->
                                    <!-- <div class="mb-4">                                        
                                        <button aria-label="button" type="button" onclick="window.location.href='รายการตรวจสอบภายใน_3-<?php echo $_GET['id']; ?>-<?php echo $_GET['get']; ?>-<?php echo $_GET['shl'];?>.html';" class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                                            <i data-lucide="plus" class="inline-block size-4"></i> <span class="align-middle">จัดการตัวเลือกย่อยภายใน</span>
                                        </button>
                                    </div> -->
                                <?php } ?>
                            <!-- </form> -->
...
<script type="text/javascript">    
    $(document).ready(function () {
        ...
        $('#add').click(function () {
            ...
            html_code += "<td class='px-2 py-1 border border-slate-200 dark:border-zink-500'><select class='form-input appearance-none border-slate-300 focus:outline-none focus:border-custom-500 param5' data-choices-search-false=''><option value='BEFOREWORK'>ก่อนปฏิบัติงาน</option><option value='BEFORESTART'>ก่อนติดเครื่องยนต์</option><option value='AFTERSTART'>หลังติดเครื่องยนต์</option><option value='TRAILLER'>เทรลเลอร์</option></select></td>";
